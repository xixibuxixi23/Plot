...
CUDA_VISIBLE_DEVICES=0 "$ROOT/envs/plot-env-py311-cu128/bin/python" \
  ...
  --m4-checkpoint "$ROOT/runs/m4-state/text-m2-rollout-64f-support-pilot100-20260923-v1/latest.pt" \
  --output "$ROOT/runs/m4-state/text-m2-rollout-64f-support-pilot100-20260923-v1/eval-s07-2239.json" \
  --target 0 \
  --max-blocks 60 \
