...
run="$root/runs/m4-state/text-hier-pointer-20k-20260923-v1"
initialize="$root/runs/m4-state/text-target-pointer-20k-20260923-v1/best-val-loss.pt"
case "$node" in
  rcz5) node_rank=0 ;;
  rcz6) node_rank=1 ;;
...
exec "$python" -m torch.distributed.run \
  ...
  --master-addr=29.163.242.17 --master-port=29658 \
  ...
  --lr 3e-5 --weight-decay 0.05 --warmup 500 \
