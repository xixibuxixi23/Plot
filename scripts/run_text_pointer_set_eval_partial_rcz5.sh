...
cd "$ROOT/Plot"
CUDA_VISIBLE_DEVICES=1 "$ROOT/envs/plot-env-py311-cu128/bin/python" \
  ...
  --batch-size 16 \
  --per-scenario 500 \
  --output "$ROOT/runs/m4-state/text-hier-pointer-20k-20260923-v1/eval/pointer-any-future-goal-val-stratified.json"
