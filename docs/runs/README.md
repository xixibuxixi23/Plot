...
|---|---|---|---|---:|---:|---|---|
| M1 | `m1_flow_2nodes_b32_eval10k_v2` | legacy source hashes; compatible PLOT migration at `4b6ce14` | `m1-h200-2node` | 1,127,000 | 1,179,960 at 2026-09-13 06:30 UTC | `Polis/outputs/m1_flow_2nodes_b32_eval10k_v2` | local logs |
