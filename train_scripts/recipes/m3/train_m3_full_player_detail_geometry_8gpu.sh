...
# Full-network player-detail training with learned geometry-aware reference attention.
# This uses a soft view/local-coordinate prior; it never samples reference pixels into RGB.
...
RESUME="${RESUME:-}"
OUTPUT_DIR="${OUTPUT_DIR:-${PLOT_ROOT}/outputs/m3_full_player_detail_geometry_34750_39750_20260915}"
